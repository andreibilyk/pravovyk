...
def repeat_all_messages(message):
 ...
 bot.send_message(message.chat.id,''' Споживач має наступні <b>права</b>:\n
- <b>захист своїх прав державою</b> (здійснюють управління захисту прав споживачів, органи Держспоживстандарту, судові органи);\n
- <b>належну якість</b> продукції та обслуговування;\n
- <b>безпеку</b> продукції;\n
- необхідну, доступну, достовірну та вчасну <b>інформацію</b> про продукцію, її кількість, якість, асортимент, а також про її виробника (виконавця, продавця);\n
- відшкодування <b>майнової та моральної шкоди</b>, завданої через недоліки продукції (дефекту), відповідно до закону;\n
- звернутися до суду та інших уповноважених державних органів по <b>захист порушених прав</b>;\n
об’’єднатися в <b>громадські організації</b> споживачів (об’’єднання споживачів).’\n ''', parse_mode = 'HTML')
